...
const Banner = () => {
  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-2 md:mx-10'>
        {/**------- Left Side ----- */}
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24'>
          <div className='text-xl sm:text-2l md:text-3xl lg:text-4xl font-semibold text-white'>
